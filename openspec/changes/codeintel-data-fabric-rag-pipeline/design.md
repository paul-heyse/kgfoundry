...
CPU-only FAISS indexes replaced the historical dual-index architecture, so this
section intentionally remains blank to avoid referencing deprecated behavior.
...
**Impact**: No synthesis, no reranking, compute resources underutilized.
