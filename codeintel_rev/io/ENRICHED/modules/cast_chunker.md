...
- function: `build_chunks` (line 236)
- class: `_ChunkBuilder` (line 278)
- function: `__init__` (line 289)
- function: `add_symbol` (line 296)
- function: `finalize` (line 347)
- function: `_start_chunk` (line 376)
- function: `_flush_current` (line 381)
- function: `_append_chunk` (line 391)
- function: `_split_large_symbol` (line 419)
- function: `_reset` (line 441)
...
- function: `_slice_lines` (line 572)
