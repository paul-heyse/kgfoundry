...
- class: `CSTCollector` (line 135)
- function: `index_file` (line 360)
- function: `_should_emit` (line 380)
- function: `_resolve_span` (line 407)
- function: `_node_id` (line 417)
- function: `_node_name` (line 423)
- function: `_definition_or_class_name` (line 434)
- function: `_assign_target_name` (line 440)
- function: `_annassign_target_name` (line 448)
- function: `_attribute_or_name` (line 454)
- function: `_call_target_name` (line 462)
- function: `_import_alias_name` (line 468)
- function: `_parent_chain` (line 486)
- function: `_scope` (line 515)
- function: `_extract_module_doc` (line 532)
- function: `_summarize` (line 539)
- function: `_doc_snippet` (line 546)
- function: `_preview_text` (line 557)
- function: `_decorators` (line 565)
- function: `_call_targets` (line 581)
- function: `_annotation` (line 593)
- function: `_import_metadata` (line 609)
- function: `_normalize_alias` (line 647)
- function: `_normalize_module_expr` (line 664)
- function: `_is_public` (line 674)
- function: `_resolve_lazy` (line 684)
- function: `_qualified_name_entries` (line 693)
- function: `_normalize_qnames` (line 712)
- function: `_module_name_from_path` (line 721)
- function: `_build_parse_error_node` (line 752)
