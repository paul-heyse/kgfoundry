...
- class: `_CollectorStatsBuilder` (line 46)
- class: `CSTCollector` (line 151)
- function: `index_file` (line 376)
- function: `_should_emit` (line 396)
- function: `_resolve_span` (line 423)
- function: `_node_id` (line 433)
- function: `_node_name` (line 439)
- function: `_definition_or_class_name` (line 450)
- function: `_assign_target_name` (line 456)
- function: `_annassign_target_name` (line 464)
- function: `_attribute_or_name` (line 470)
- function: `_call_target_name` (line 478)
- function: `_import_alias_name` (line 484)
- function: `_parent_chain` (line 502)
- function: `_scope` (line 531)
- function: `_extract_module_doc` (line 548)
- function: `_summarize` (line 555)
- function: `_doc_snippet` (line 562)
- function: `_preview_text` (line 573)
- function: `_decorators` (line 581)
- function: `_call_targets` (line 597)
- function: `_annotation` (line 609)
- function: `_import_metadata` (line 625)
- function: `_normalize_alias` (line 663)
- function: `_normalize_module_expr` (line 680)
- function: `_is_public` (line 690)
- function: `_resolve_lazy` (line 700)
- function: `_qualified_name_entries` (line 709)
- function: `_normalize_qnames` (line 728)
- function: `_module_name_from_path` (line 737)
- function: `_build_parse_error_node` (line 768)
