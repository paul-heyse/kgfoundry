...
- function: `_traits_from_row` (line 796)
- function: `_build_coverage_rows` (line 857)
- function: `_build_hotspot_rows` (line 868)
- function: `_write_exports_outputs` (line 882)
- function: `_write_graph_outputs` (line 889)
- function: `_write_uses_output` (line 894)
- function: `_write_typedness_output` (line 898)
- function: `_write_doc_output` (line 912)
- function: `_write_coverage_output` (line 926)
- function: `_write_config_output` (line 930)
- function: `_write_hotspot_output` (line 934)
- function: `_write_modules_json` (line 938)
- function: `_write_markdown_modules` (line 942)
- function: `_write_repo_map` (line 953)
- function: `_write_symbol_graph` (line 968)
- function: `_write_tabular_records` (line 975)
- function: `_normalize_type_signal_map` (line 982)
- function: `_normalize_metric_map` (line 998)
- function: `_normalize_path_key` (line 1016)
- function: `_group_configs_by_dir` (line 1020)
- function: `_config_refs_for_row` (line 1031)
- function: `_ancestor_dirs` (line 1047)
- function: `_dir_key_from_path` (line 1062)
- function: `_should_mark_overlay` (line 1069)
- function: `_ensure_package_overlays` (line 1099)
- function: `_normalized_rel_path` (line 1183)
- function: `_write_tag_index` (line 1187)
