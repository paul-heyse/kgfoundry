...
def test_violation_record_creation() -> None:
...
def test_violation_record_is_frozen() -> None:
...
def test_record_check_without_violations() -> None:
...
def test_record_check_with_violations() -> None:
...
def test_multiple_checks_accumulation() -> None:
...
def test_snapshot_summary_compliance_rate() -> None:
...
def test_snapshot_summary_files_with_violations() -> None:
...
def test_snapshot_summary_violation_types() -> None:
...
def test_structured_logs_format() -> None:
...
def test_structured_logs_summary_event() -> None:
...
def test_structured_logs_violation_events() -> None:
...
def test_compliance_rate_100_percent() -> None:
...
def test_compliance_rate_zero_percent() -> None:
