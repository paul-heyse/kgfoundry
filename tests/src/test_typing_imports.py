...
def test_no_direct_private_types_imports() -> None:
...
def test_no_imports_of_deprecated_resolve_shims() -> None:
...
def test_gate_import_available_in_kgfoundry_common_typing() -> None:
