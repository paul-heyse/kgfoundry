...
def test_gate_import_available_module() -> None:
    ...
    assertions.expect_true(hasattr(json_module, "dumps"), reason="json_module should have dumps")


def test_gate_import_missing_module() -> None:
...
def test_gate_import_with_purpose_in_message() -> None:
...
def test_gate_import_suggests_pip_install() -> None:
...
def test_gate_import_caches_result() -> None:
...
def test_safe_get_type_existing_type() -> None:
...
def test_resolve_numpy_returns_module() -> None:
...
def test_resolve_fastapi_returns_module() -> None:
...
def test_type_aliases_are_defined() -> None:
    ...
    assertions.expect_true(ProblemDetails is not None, reason="ProblemDetails should be defined")
...
def test_navmap_is_dict_alias() -> None:
...
def test_problem_details_is_dict_alias() -> None:
    """ProblemDetails represents RFC 9457 Problem Details."""
    assertions.expect_true(ProblemDetails is not None, reason="ProblemDetails should be defined")


def test_symbol_id_is_str_alias() -> None:
    """SymbolID is a string alias for symbol identifiers."""
    assertions.expect_true(SymbolID is not None, reason="SymbolID should be defined")


def test_json_value_covers_json_types() -> None:
